...
> Auto-maintained by OpenWolf. Last scanned: 2026-05-14T10:58:33.318Z
...
- `script.js` — MaKandra — script.js  (API-connected) (~42868 tok)
- `style.css` — Styles: 66 rules, 25 vars (~17338 tok)
...
- `index (1).html` — MaKandra – Vind Diensten in Suriname (~6834 tok)
- `script.js` — CATEGORIES: scoreColor, buildScoreRing (~17221 tok)
- `style.css` — Styles: 66 rules, 25 vars (~16646 tok)
